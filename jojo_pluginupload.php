...
class JOJO_Plugin_Jojo_pluginupload extends JOJO_Plugin
{
	function _getContent()
	{
		...
		else if ( JOJO::fileExists(_BASEPLUGINDIR.'/jojo_pluginmanager/pluginupload_fields.php')) {
			include(_BASEPLUGINDIR.'/jojo_pluginmanager/pluginupload_fields.php');
		}
	...
	function sendEnquiry()
	{
		...
		if ($_POST['form_tags']) {
			$_POST['form_tags'] = str_replace(' ' , '' ,  $_POST['form_pluginversion']);
		}
		...
		if (count($errors) == 0) {
			...
			if ($pluginid == '') {
				...
				mkdir(_DOWNLOADDIR."/plugins/".$_POST['form_pluginname']);
			}
			...
			mkdir(_DOWNLOADDIR."/plugins/".$_POST['form_pluginname']."/".$_POST['form_pluginversion']);
